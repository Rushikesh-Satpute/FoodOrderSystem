      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="flex gap-1 bg-white rounded-xl p-1.5 shadow-[0_2px_10px_rgba(0,0,0,0.06)] w-fit border border-gray-100">
          <button
            ...
            className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 cursor-pointer flex items-center gap-2 ${customerTab === 'menu'
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 cursor-pointer flex items-center gap-2 relative ${customerTab === 'orders'
              ? 'bg-green-600 text-white shadow-md'
              : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
              }`}
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {items.map(item => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className={`bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.06)] flex flex-col overflow-hidden transition-all duration-300 hover:shadow-[0_4px_25px_rgba(0,0,0,0.12)] hover:-translate-y-1 border-2 ${inCart ? 'border-green-300' : 'border-transparent'
                          }`}
                      >
            ...
            <div className="space-y-6">
              ...
              {myOrders.map(order => {
                ...
                return (
                  <div
                    key={order.id}
                    className={`bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.06)] p-5 border transition-all duration-300 ${order.status === 'Picked Up' ? 'border-gray-100 opacity-70' : 'border-green-100 shadow-[0_4px_20px_rgba(34,197,94,0.1)]'
                      }`}
                  >
                        ...
                        return (
                          <div key={step} className="flex items-center flex-1">
                            <div className="flex flex-col items-center">
                              <div
                                className={`w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-medium transition-all duration-300 ${done ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-400'
